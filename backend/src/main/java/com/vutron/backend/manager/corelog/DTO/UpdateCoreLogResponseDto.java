...
public record UpdateCoreLogResponseDto(
    long id,
    long coreProjectId,
    long coreTypeLogId,
    ...
    public static UpdateCoreLogResponseDto from(CoreLogRepository.CoreLogRecord record) {
        return new UpdateCoreLogResponseDto(
            record.id(),
